...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className="text-neutral-300 hover:text-white transition-colors cursor-pointer" onClick={onClick} />
  ) : (
    <IconMenu2 className="text-neutral-300 hover:text-white transition-colors cursor-pointer" onClick={onClick} />
  );
};
...
export const NavbarLogo = () => {
  return (
    <a
      href="#"
      className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-neutral-300 hover:text-white transition-colors"
    >
      <img
        src="/icons/beelialogo.png"
        alt="Beelia logo"
        width={30}
        height={30}
      />
      <span className="font-inria-sans font-medium text-neutral-300 hover:text-white transition-colors">Beelia</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none text-neutral-300 hover:text-white border border-neutral-600/50 hover:border-neutral-500/70",
