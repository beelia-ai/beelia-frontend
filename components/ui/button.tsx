...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', children, isLoading, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-black text-white hover:bg-gray-900 focus-visible:ring-gray-500',
      secondary: 'bg-gray-100 text-black hover:bg-gray-200 focus-visible:ring-gray-500',
      outline: 'border-2 border-black text-black hover:bg-black/5 focus-visible:ring-gray-500',
