  ...
  return (
    <>
      ...
      <defs>
        <motion.linearGradient
          ...
          animate={
            isRetracting
              ? {}
              : {
                  x1: [topMid.x, rightMid.x, bottomMid.x, leftMid.x, topMid.x],
                  y1: [topMid.y, rightMid.y, bottomMid.y, leftMid.y, topMid.y],
                  x2: [
                    bottomMid.x,
                    leftMid.x,
                    topMid.x,
        ...
        >
          <stop
            stopColor={useWhiteColor ? "#ffffff" : beamColor}
            stopOpacity="0"
          />
          <stop
            offset="2%"
...
export function TraceLinesAnimated({
  ...
  const dotsOpacity =
    (heroScrollProgress ?? 0) >= 0.02
      ? 0
      : Math.max(0, 1 - (heroScrollProgress ?? 0) / 0.02);
  ...
  return (
    ...
    >
      ...
      <g
        style={{
          clipPath: isRetracting
            ? `inset(0 0 0 ${scrollProgress * 100}%)`
            : "none",
          opacity: isRetracting ? 1 - scrollProgress : 1,
        }}
      >
      ...
      <g
        style={{
          clipPath: isRetracting
            ? `inset(0 ${scrollProgress * 100}% 0 0)`
            : "none",
          opacity: isRetracting ? 1 - scrollProgress : 1,
        }}
      >
