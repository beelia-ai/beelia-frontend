...
export interface FluidGlassProps {
  /**
   * Mode of the glass effect: 'lens', 'bar', or 'cube'
   */
  mode?: Mode;
  /**
   * Props specific to lens mode
   */
  lensProps?: ModeProps;
  /**
   * Props specific to bar mode
   */
  barProps?: ModeProps;
  /**
   * Props specific to cube mode
   */
  cubeProps?: ModeProps;
  /**
...
/**
 * FluidGlass - A reusable glass morphism effect component
 * 
 * This component requires 3D models to function correctly.
 * Place the following GLB files in the 'public/assets/3d' directory:
 * - 'lens.glb'
 * - 'bar.glb'
 * - 'cube.glb'
 * 
