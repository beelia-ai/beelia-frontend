    ...
    <>
      ...
      >
        ...
        <VideoGlobe
          ...
          beeliaOpacity={beeliaOpacity}
          presentVideoOpacity={presentVideoOpacity}
          futureTransitionCombinedOpacity={futureTransitionCombinedOpacity}
          futureMainVideoOpacity={futureMainVideoOpacity}
          hidePastVideo={hidePastVideo}
          showFutureMain={showFutureMain}
          isMobile={isMobile}
          isHeroVisible={isHeroVisible}
          beeliaVideoRef={beeliaVideoRef}
